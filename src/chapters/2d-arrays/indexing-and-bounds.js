...
const rows = grid.length;     // 3 (like having 3 floors)
const columns = grid[0].length; // 4 (like having 4 rooms per floor)
\`\`\`

Pro tip: Always check both dimensions. Arrays are not all square!

## Bounds Checking

Bounds checking is confirming that there is a valid element before you perform an operation there. It's like a safety net that prevents you from falling off the edge of your grid.
...
Remember, good indexing and bounds checking habits are like having a good safety system - they might seem like extra work at first, but they'll save you tons of debugging time and prevent crashes in your applications. Keep practicing these patterns, and they'll become second nature!`,
  exercise: null
};