...
export default [
  {
    ...
    questionJsx: "Which of the following scenarios are best implemented using a Stack (LIFO) data structure?",
    answers: [
  ...
  },
  {
    ...
    questionJsx: "What is the time complexity of push, pop, and peek operations in an array-based stack implementation?",
    answers: [
      "O(1)",
      "O(log n)",
      "O(n)",
  ...
  {
    type: QUESTION_TYPES.RADIO,
    questionJsx: "What does the acronym that describes stack behavior stand for?",
    answers: [
