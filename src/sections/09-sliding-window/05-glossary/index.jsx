...
export default {
  ...
  content: `This glossary contains important terms and concepts related to the sliding window technique in financial analysis. Understanding these terms will help you communicate effectively about algorithms and data structures during interviews and technical discussions.
${formatGlossary(data)}
`,
  exercise: null
};