...
export const questions = [
  {
    ...
    question: "What will be the size of this Set after all operations?\n\n```javascript\nconst mySet = new Set();\n\nmySet.add(\"apple\");\nmySet.add(\"banana\");\nmySet.add(\"apple\");   // duplicate\nmySet.add(\"cherry\");\nmySet.add(\"banana\");  // duplicate\n\nconsole.log(mySet.size);\n```",
    correctAnswer: "3",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What will this code output? (Consider reference vs value comparison)\n\n```javascript\nconst obj1 = { id: 1 };\nconst obj2 = { id: 1 };\n\nconst mySet = new Set();\nmySet.add(obj1);\nmySet.add(obj2);\n\nconsole.log(mySet.size === 1);\n```",
    correctAnswer: "false",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What is the average time complexity for Map operations like get(), set(), and has() in a well-implemented hash table?",
    correctAnswer: "O(1)",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What is the average time complexity for Set operations like add(), delete(), and has()?",
    correctAnswer: "O(1)",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What component of a hash table is responsible for converting keys into array indices?",
  ...
  },
  {
    ...
    question: "What are the key differences between Maps and Sets?",
    options: [
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What collision resolution technique stores multiple key-value pairs at the same array index using a list or array?",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "What is the typical load factor threshold (as a decimal) used to trigger dynamic resizing in hash tables?",
    correctAnswer: "0.75",
  ...
  {
    type: QUESTION_TYPES.TEXT,
    question: "Which set operation would combine all allergies from multiple family members to create a comprehensive family allergy history?",
    correctAnswer: "union",
