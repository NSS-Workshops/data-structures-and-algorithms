...
export const questions = [
  {
    ...
    question: "What are the two essential requirements for binary search to work effectively?",
    answers: [
  ...
  {
    type: QUESTION_TYPES.RADIO,
    question: "What is the time complexity of binary search, and why is it that efficient?",
    answers: [
  ...
  {
    type: QUESTION_TYPES.RADIO,
    question: "What happens when you call `array.sort()` on an array of numbers like `[1.99, 15.99, 100.99, 20.99, 3.99]` without providing a comparator function?",
    answers: [
  ...
  {
    type: QUESTION_TYPES.RADIO,
    question: "In a JavaScript comparator function with parameters a and b, what should you return if element a should come BEFORE element b in the sorted order?",
    answers: [
      "false",
      "true",
      "A positive number",
