...
export default function githubOAuthPlugin(options = {}) {
  ...
  return {
    ...
    configureServer(server) {
      ...
      console.log(
        "[OAuth Plugin] GitHub OAuth plugin initialized with credentials:",
        {
      ...
      server.middlewares.use(async (req, res, next) => {
        ...
        // This is more flexible and handles both /oauth/github/token and /data-structures-and-algorithms/oauth/github/token
        if (
          ...
          try {
            ...
            if (!clientId || !clientSecret) {
              ...
              res.end(
                JSON.stringify({
                  ...
                  details:
                    "Check VITE_OAUTH_CLIENT_ID and VITE_OAUTH_CLIENT_SECRET in .env.local",
                })
              );
              return;
            }
            ...
            console.log(
              "[OAuth Plugin] Calling GitHub API with client ID:",
            ...
            console.log(
              "[OAuth Plugin] GitHub API response status:",
              response.status
            );
            ...
            if (tokenData.error) {
              console.error(
                "[OAuth Plugin] GitHub API returned error:",
                tokenData.error
              );
              res.statusCode = 400;
